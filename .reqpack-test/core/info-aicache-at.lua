return {
  name = "ollama info aicache @tag",
  request = {
    action = "info",
    system = "ollama",
    prompt = "qwen3@4b",
  },
  fixtureRoot = "../fixtures-aicache-info-at",
  fixtureFiles = {
    {
    ...
    },
    {
      ...
      content = [[{"fetched_at":"2026-05-28T12:00:00Z","upstream_metadata":{"homepage":"https://ollama.com/library/qwen3:4b","source_url":"https://ollama.com/library/qwen3:4b","format":"gguf","family":"qwen3","families":["qwen3"],"parameter_size":"4B","quantization":"Q4_K_M","capabilities":["completion"],"context_length":131072}}]],
    },
  },
  environment = {
