return {
  ...
  fixtureRoot = "../fixtures-remove-model",
  fixtureFiles = {
    {
    ...
    },
    {
      ...
      content = [[{"fetched_at":"2026-05-28T12:00:00Z","upstream_metadata":{"homepage":"https://ollama.com/library/qwen3:8b"}}]],
    },
    {
      path = "data/aicache/blobs/sha256/bb/bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
      content = "weights",
    },
    {
      path = "data/aicache/views/by-kind/model-llm/ollama/model-llm/qwen3:8b@1111111111111111111111111111111111111111111111111111111111111111/model.gguf",
      content = "weights",
    },
    {
      path = "data/aicache/views/by-format/gguf/ollama/model-llm/qwen3:8b@1111111111111111111111111111111111111111111111111111111111111111/model.gguf",
      content = "weights",
    },
    {
      path = "data/aicache/views/by-source/ollama/model/qwen3_8b/1111111111111111111111111111111111111111111111111111111111111111/model.gguf",
      content = "weights",
    },
  },
  environment = {
