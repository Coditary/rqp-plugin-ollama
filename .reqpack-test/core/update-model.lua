return {
  ...
  fixtureRoot = "../fixtures-update-model",
  fixtureDirs = {
    "data/aicache/artifacts/ollama/model-llm/qwen3:8b@2222222222222222222222222222222222222222222222222222222222222222",
  ...
  fakeExec = {
    ...
    },
    {
      match = "sha256sum '",
      exitCode = 0,
      stdout = "2222222222222222222222222222222222222222222222222222222222222222  ${fixtureRoot}/models/manifests/registry.ollama.ai/library/qwen3/8b\n",
      stderr = "",
      success = true,
    },
    {
