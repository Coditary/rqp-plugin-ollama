return {
  ...
  fixtureRoot = "../fixtures-install-model",
  fixtureDirs = {
    "data/aicache/artifacts/ollama/model-llm/qwen3:8b@1111111111111111111111111111111111111111111111111111111111111111",
    "data/aicache/views/by-source/ollama/model/qwen3_8b",
  },
  fixtureFiles = {
    {
      path = "models/manifests/registry.ollama.ai/library/qwen3/8b",
    ...
    },
    {
      ...
      content = [[{"model_format":"gguf","model_family":"qwen3","model_families":["qwen3"],"model_type":"8B","file_type":"Q4_K_M","architecture":"amd64","os":"linux","rootfs":{"type":"layers","diff_ids":[]},"capabilities":["completion"],"context_length":131072}]],
    },
    {
  ...
  fakeExec = {
    ...
    },
    {
      match = "sha256sum '",
      exitCode = 0,
      stdout = "1111111111111111111111111111111111111111111111111111111111111111  ${fixtureRoot}/models/manifests/registry.ollama.ai/library/qwen3/8b\n",
      stderr = "",
      success = true,
    },
    {
